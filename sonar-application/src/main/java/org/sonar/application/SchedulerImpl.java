...
import org.sonar.process.monitor.Lifecycle;
import org.sonar.process.monitor.ProcessEventListener;
import org.sonar.process.monitor.ProcessLifecycleListener;
import org.sonar.process.monitor.SQProcess;
...
public class SchedulerImpl implements Scheduler, ProcessEventListener, ProcessLifecycleListener, AppStateListener {
  ...
  public void schedule() {
    ...
    for (ProcessId processId : settings.getEnabledProcesses()) {
