...
public class ClusterPropertiesTest {
  ...
  public void test_default_values() throws Exception {
    AppSettings appSettings = TestAppSettings.forCliArguments(new Properties());
  ...
  public void test_members() {
    ...
    assertThat(
      new ClusterProperties(TestAppSettings.forCliArguments(properties)).getMembers()).isEqualTo(
    ...
    assertThat(
      new ClusterProperties(TestAppSettings.forCliArguments(properties)).getMembers()).containsExactlyInAnyOrder(
        "192.168.1.2:5501");
